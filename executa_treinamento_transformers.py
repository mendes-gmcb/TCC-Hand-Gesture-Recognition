...
def main():
    ...
    X_train, X_test, y_train, y_test = train_test_split(sequencias, rotulos, test_size=0.2, random_state=42)
    ...
    num_classes = 2  # Número de classes de gestos
    ...
    torch.save(model.state_dict(), 'modelos/modelo_transformer_vfinal.pt')
    print("Modelo salvo como 'modelo_transformer_vfinal.pt'")
...
# variar a porcentagem de 80 / 20 de treino de treino de teste 
# 